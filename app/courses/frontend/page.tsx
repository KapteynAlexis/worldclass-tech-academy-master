    ...
    <>
      <section className="py-20 px-6 bg-gray-50 text-black">
       <Link href="/courses" className="px-8 py-4 rounded-md bg-[#FF4400] text-white font-semibold hover:opacity-90 transition  hover:bg-white hover:text-[#FF4400]">← Back
        ...
        <h1 className="mt-6 mb-4 text-4xl pt-6 font-bold max-w-4xl">Frontend Development Masterclass</h1>
        <p className="mb-8 text-gray-600">
          Beginner to Advanced · 100% Online
        </p>

        <p className="mb-10">
          Build modern, responsive, and user-friendly websites with Worldclass
          Tech Academy’s Frontend Development Masterclass — a structured online
          training program designed to take you from beginner to industry-ready
          in just 12 weeks.
        </p>
        ...
        <ul className="list-disc pl-6 mb-10 space-y-2">
          ...
          <li>Outcome: Portfolio-ready projects & practical skills</li>
        </ul>
